			...
			<div class="connoisseur">
				...
				<div class="conShow">
					<table border="1" cellspacing="0" cellpadding="0">
						<tr>
							<td width="335px" class="tdColor">序号</td>
							<td width="500px" class="tdColor tdC">分类名称</td>
							<td width="355px" class="tdColor">排序</td>
							<td width="335px" class="tdColor">操作</td>
						...
						<tr>
							...
							<td>{{$v->sort_order}}</td>										
							<td><a href="{{url('cat/edit/'.$v->cat_id)}}">
